...
namespace SmallBin
{
    ...
    public class SecureFileDatabase : IDisposable
    {
        ...
        /// <param name="tags">Optional list of tags to associate with the file for easier searching and categorization.</param>
        /// <param name="contentType">Optional MIME type specifying the type of content stored in the file.</param>
        /// <exception cref="FileNotFoundException">Thrown when the specified file does not exist.</exception>
        public void SaveFile(string filePath, List<string> tags = null, string contentType = null)
        {
        ...
        public byte[] GetFile(string fileId)
        {
            ...
            var entry = _database.Files[fileId];
        ...
        {
            byte[] fileContent = File.ReadAllBytes(_dbPath);
        ...
        public void Save()
        {
            ...
            try
            {
                ...
                string json = JsonSerializer.Serialize(_database, jsonOptions);
